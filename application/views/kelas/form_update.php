        ...
        <div class="span10">
            <div id="konten" style="width: 100%;height: 100%;background-color:white;padding: 10px ">
                <form id="frm_kelas" method="POST">
                    <fieldset>
                        <legend>Ubah Kelas (Kode Kelas : <?= $kelas['KODE_KELAS'] ?>,Kode Masuk : <?= $kelas['KODE_MASUK'] ?>)</legend>
                        <label for="nama">Nama Kelas </label>
                        <div class="input-control text" data-role="input-control">
                            <input value="<?= $kelas['NAMA_KELAS'] ?>" name="nama_kelas" id="usernamereg" type="text" placeholder="nama_kelas" autofocus="" required>
                        ...
                        <div class="input-control text" data-role="input-control">
                            <input name="kode_tingkatkelas" value="<?= $kelas['KETERANGAN_TINGKATKELAS'] ?>" id="kode_tingkatkelas" type="text" placeholder="tingkat kelas" class="search-query" autofocus="" required>
                            <button class="btn-reveal" tabindex="-1" type="button"></button>
                            <input type="hidden" id="kode_tingkatkelas_hidden" name="kode_tingkatkelas_hidden" value="<?= $kelas['KODE_TINGKATKELAS'] ?>">
                            <span id="ket_kode"></span>
                        </div>
                        <div class="input-control button" data-role="input-control">
                            <input type="submit" value="Ubah" id="btn_submit">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#kode_tingkatkelas").on("select2-blur", function (e) {
            ...
            $("#kode_tingkatkelas_hidden").val(tingkat_kelas.kode_tingkatkelas);
        });
        ...
        $("#ket_kode").html('kode tingkat kelas : ' + <?= $kelas['KODE_TINGKATKELAS'] ?>);
    });
</script>