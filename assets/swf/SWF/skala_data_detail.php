...
//Function to sanitize values received from the form. Prevents SQL injection
	...
	//Create UPDATE query
	$qry = 	"UPDATE `riwayat_permainan` SET `TANGGAL_RIWAYAT` = '$tanggal_riwayat', `RIWAYAT_WAKTUMAIN` = '$hours2:$minutes2:$seconds2', `RIWAYAT_EXP` = '$riwayat_exp',  `RIWAYAT_GOLD` = '$riwayat_gold', `RIWAYAT_KLIK` = '$riwayat_klik', `RIWAYAT_ACCURACY` = '$accuracy', `RIWAYAT_STATUS` = '$riwayat_status', `STATUS_RIWAYAT` = '$status_riwayat' WHERE CONCAT(`riwayat_permainan`.`KODE_RIWAYAT`) = '$kode_riwayat'";
